...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1d9e; // addresses start with "TU";
...
const uint64_t MONEY_SUPPLY                                  = 10000000000;
...
const char     CRYPTONOTE_NAME[]                             = "tulip";
